...
<div class="row">
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <a href="<?= BASE_URL ?>modules/sales/quotations/quotation_list.php" class="text-decoration-none">
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <a href="<?= BASE_URL ?>modules/notifications/index.php" class="text-decoration-none">
